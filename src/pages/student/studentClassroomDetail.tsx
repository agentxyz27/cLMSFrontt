    ...
    async function fetchData() {
      try {
        const [classRoomRes, lessonsRes, progressRes] = await Promise.all([
          api.get<ClassRoom>(`/classrooms/${id}/student`, token),
          api.get<LessonSummary[]>(`/classrooms/${id}/lessons`, token),
              ...
              >
                ...
                <div style={{ padding: '8px 12px' }}>
                  ...
                  <div style={{ marginTop: 8 }}>
                    <button
                      onClick={() => navigate(`/student/classrooms/${id}/lessons/${lesson.id}`)}
                      style={{ width: '100%' }}
                    >
